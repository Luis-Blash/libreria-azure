...
# controlador
from app.controller.librosController import actualizar_bibloteca, deleteLibro, subir_bibloteca, todolosLibros
...
libro_bp.route('/delete-libro/<id>', methods=['GET','POST'])(deleteLibro)